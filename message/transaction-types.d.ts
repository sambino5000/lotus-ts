 ...
 */
export declare type InputTemplate<CompilerType, RequireEstimate = false, CompilationDataType = CompilationData<never>> = Input<Uint8Array | (RequireEstimate extends true ? CompilationDirectiveUnlockingEstimate<CompilerType, CompilationDataType> : CompilationDirectiveUnlocking<CompilerType, CompilationDataType>)>;
/**
 ...
 * `excessiveSatoshis`).
 */
export declare type TransactionTemplate<CompilerType, EnableFeeEstimation = false, CompilationDataType = CompilationData<never>> = TransactionCommon<InputTemplate<CompilerType, EnableFeeEstimation, CompilationDataType>, OutputTemplate<CompilerType, EnableFeeEstimation, CompilationDataType>>;
/**
 ...
 */
export declare type BytecodeGenerationCompletion = BytecodeGenerationCompletionInput | BytecodeGenerationCompletionOutput;
...
export declare type TransactionGenerationAttempt = TransactionGenerationError | TransactionGenerationSuccess;
