 ...
 */
export declare type MaybeReadResult<Type> = ReadResult<Type> | string;
/**
 * A function that reads some data beginning at a {@link ReadPosition}.
 */
export declare type ReadFunction<Type> = (position: ReadPosition) => MaybeReadResult<Type>;
declare type ExtractReadFunctionResults<T extends readonly ReadFunction<unknown>[]> = {
