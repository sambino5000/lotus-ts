...
export interface Secp256k1Wasm {
     ...
     */
    readonly privkeyTweakAdd: (contextPtr: number, secretKeyPtr: number, tweakNum256Ptr: number) => 0 | 1;
    /**
     ...
     * @param tweakNum256Ptr - pointer to a 256 bit int representing the tweak value
     */
    readonly privkeyTweakMul: (contextPtr: number, secretKeyPtr: number, tweakNum256Ptr: number) => 0 | 1;
    /**
     ...
     * @param secretKeyPtr - pointer to a 32-byte private key
     */
    readonly pubkeyCreate: (contextPtr: number, publicKeyPtr: number, secretKeyPtr: number) => 0 | 1;
    /**
     ...
     */
    readonly pubkeyParse: (contextPtr: number, publicKeyOutPtr: number, publicKeyInPtr: number, publicKeyInLength: 33 | 65) => 0 | 1;
    /**
     ...
     * @param tweakNum256Ptr - pointer to a 256 bit int representing the tweak value
     */
    readonly pubkeyTweakAdd: (contextPtr: number, publicKeyPtr: number, tweakNum256Ptr: number) => 0 | 1;
    /**
     ...
     * @param tweakNum256Ptr - pointer to a 256 bit int representing the tweak value
     */
    readonly pubkeyTweakMul: (contextPtr: number, publicKeyPtr: number, tweakNum256Ptr: number) => 0 | 1;
    /**
     ...
     * signature
     */
    readonly recover: (contextPtr: number, publicKeyPtr: number, rSigPtr: number, msg32Ptr: number) => 0 | 1;
    /**
     ...
     */
    readonly recoverableSignatureParse: (contextPtr: number, outputRSigPtr: number, inputSigPtr: number, rid: number) => 0 | 1;
    /**
     ...
     */
    readonly schnorrSign: (contextPtr: number, outputSigPtr: number, msg32Ptr: number, secretKeyPtr: number) => 0 | 1;
    /**
     ...
     * (internal format)
     */
    readonly schnorrVerify: (contextPtr: number, sigPtr: number, msg32Ptr: number, publicKeyPtr: number) => 0 | 1;
    /**
     ...
     * @param secretKeyPtr - pointer to a 32-byte secret key
     */
    readonly sign: (contextPtr: number, outputSigPtr: number, msg32Ptr: number, secretKeyPtr: number) => 0 | 1;
    /**
     ...
     * format)
     */
    readonly signatureNormalize: (contextPtr: number, outputSigPtr: number, inputSigPtr: number) => 0 | 1;
    /**
     ...
     */
    readonly signatureParseCompact: (contextPtr: number, sigOutPtr: number, compactSigInPtr: number) => 0 | 1;
    /**
     ...
     */
    readonly signatureParseDER: (contextPtr: number, sigOutPtr: number, sigDERInPtr: number, sigDERInLength: number) => 0 | 1;
    /**
     ...
     * (internal format)
     */
    readonly signatureSerializeDER: (contextPtr: number, outputDERSigPtr: number, outputDERSigLengthPtr: number, inputSigPtr: number) => 0 | 1;
    /**
     ...
     * @param secretKeyPtr - pointer to a 32-byte secret key
     */
    readonly signRecoverable: (contextPtr: number, outputRSigPtr: number, msg32Ptr: number, secretKeyPtr: number) => 0 | 1;
    /**
     ...
     * (internal format)
     */
    readonly verify: (contextPtr: number, sigPtr: number, msg32Ptr: number, pubkeyPtr: number) => 0 | 1;
}
