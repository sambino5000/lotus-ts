 ...
 */
export declare type WalletImportFormatType = 'mainnet' | 'mainnetUncompressed' | 'testnet' | 'testnetUncompressed';
/**
...
export declare const decodePrivateKeyWif: (wifKey: string, sha256?: {
    hash: Sha256['hash'];
}) => import("../lib").Base58AddressError.unknownCharacter | import("../lib").Base58AddressError.tooShort | import("../lib").Base58AddressError.invalidChecksum | {
